...
if (!class_exists('Prep_Expert_Exam_Papers_Plugin')) {
	...
	final class Prep_Expert_Exam_Papers_Plugin {
		...
		private function enqueue_assets() {
			$css_path = plugin_dir_path(__FILE__) . 'assets/css/prep-expert-exam-papers.css';
			$css_url  = plugin_dir_url(__FILE__) . 'assets/css/prep-expert-exam-papers.css';
			...
			$js_path = plugin_dir_path(__FILE__) . 'assets/js/prep-expert-exam-papers.js';
			$js_url  = plugin_dir_url(__FILE__) . 'assets/js/prep-expert-exam-papers.js';
